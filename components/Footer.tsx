    ...
    <footer className="bg-neutral-dark text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* About */}
          <div>
            <Link href={getLocalizedPath('/', locale)} className="inline-block mb-4">
              <Image
                src="/images/Logo.png"
                alt="LUDICADÉMI"
                width={150}
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-lg font-display font-semibold mb-4">{t('quickLinks')}</h4>
          ...
          {/* Legal */}
          <div>
            <h4 className="text-lg font-display font-semibold mb-4">{t('legal')}</h4>
            <ul className="space-y-2">
              {legalLinks.map((link) => (
                <li key={link.key}>
                  <Link
        ...
        <div className="border-t border-gray-700 mt-8 pt-8">
          ...
          <p className="text-center text-gray-400">&copy; {new Date().getFullYear()} LUDICADEMI. {t('rights')}.</p>
        </div>
      </div>
    </footer>
  );
